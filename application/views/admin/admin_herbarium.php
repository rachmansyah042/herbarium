<div class="container"> 
    ...
    <div class="modal" id="editHerb" tabindex="-1" role="dialog" aria-labelledby="editHerb" aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title">Ubah Herbarium</h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                <span aria-hidden="true">&times;</span>
                </button>
            </div>
        ...
        <table class="table table-hover">
            <thead class="thead-light">
                <tr>
                    ...
                    <th scope="col" class="text-center table-lokasi">Tgl koleksi</th>
             ...
             <?php $no=1;foreach ($herbarium as $nama_herbarium) { ?>
                ...
                <tr>
                    ...
                    <td class="text-center">
                        <button type="button" data-toggle="modal" data-target="#viewHerb" class="btn btn-success btn-sm get_data" id="<?= $nama_herbarium['id_herbarium'] ?>" >Lihat</button>
